...
const INVALID_BIRTHDATE = "Invalid birthdate"
...
//aggiunto 
class InvalidBirhdateError extends Error {
    customMessage: String;
    customCode: Number;
...
export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, InvalidBirhdateError }