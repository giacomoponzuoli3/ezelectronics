...
class ReviewController {
     ...
     */
    async addReview(model: string, user: User, score: number, comment: string): Promise<void> /**:Promise<void> */ { 
        return this.dao.addReview(user.username, model, score, comment);
    }
    ...
    async deleteReview(model: string, user: User) /**:Promise<void> */ {
        return this.dao.deleteReview(user.username, model);
     }
