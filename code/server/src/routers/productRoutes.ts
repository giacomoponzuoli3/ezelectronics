...
import {
   ...
   InvalidCategoryError} from "../errors/productError";
...
class ProductRoutes {
  ...
  initRoutes() {
    ...
    this.router.post(
      ...
      body("model").isString().notEmpty(),  //error 422
      body("category").isString(), //error 422
      body("quantity").isInt({ gt: 0 }), 
      body("details").isString().optional(),
      body("sellingPrice").isFloat({ gt: 0 }),
      body("arrivalDate").optional().isISO8601(), //422
    ...
    this.router.patch(
      ...
      body("quantity").isInt({ gt: 0 }),
      body("changeDate").optional().isISO8601(),
    ...
    this.router.patch(
      ...
      param("model").trim().isString().notEmpty(),
      body("quantity").isInt({ gt: 0 }),
      body("sellingDate").optional().isISO8601(),
    ...
    this.router.get(
      ...
      this.authenticator.isLoggedIn,
      this.authenticator.isAdminOrManager,
      body("grouping").optional().isString(),
